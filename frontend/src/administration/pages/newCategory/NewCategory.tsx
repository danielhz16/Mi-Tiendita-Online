...
const NewCategory: React.FC = () => {
  ...
  const { post, loadingPost } = usePost({
    url: `${import.meta.env.VITE_URL_BACKEND}/newCategory`,
  });
...
const submit = (data: NewCategoryInterface) => {
post(data,(response) => setData((prevState) => [...prevState, response]),  undefined,  undefined, "Categoría creada con éxito");
};
